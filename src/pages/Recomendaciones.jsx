...
import { recomendaciones, datasetInfo } from "../data/variables";
                ...
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  {r.tag && (
                    <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full border
                      ${tagColors[r.tag] || "bg-white/10 text-white/40 border-white/10"}`}>
                      {r.tag}
                    </span>
                  )}
                </div>
                <p className="text-sm text-white/60 font-body leading-relaxed">{r.text}</p>
              </div>
